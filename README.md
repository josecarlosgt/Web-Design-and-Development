...
**[Persist** the data captured in the web form using Google's Apps Script Forms](https://docs.google.com/document/d/1RAIx-JZjfczV0gJI_8PNTx6jgpuOi0jKEOdl4tw8HOo/edit?usp=sharing) to store the comments from Laguna Brava Ecotourism's visitors.
...
FORM SUBMISSION MESSAGES STYLE
Contains Cascading Style Sheets (CSS) code that adjusts the visibility of the form submission messages (below)

FORM SUBMISSION MESSAGES
Contains HTML code with basic messages generated during the submission of the form

FORM SUBMISSION HANDLERS
Contains JavaScript code that submits the data in the form to the Apps Script Forms program when the user acts on the form's 'submit' button
