...
> [Link to tutorial slides](https://docs.google.com/presentation/d/1XBFzaDAOPIeGbVsMje_N27BR-bKkoZ8HO_a-sBpCCTI/edit?usp=sharing)
> [Link to business case](https://docs.google.com/document/d/1mm4LbBwQdFnHor9dPLgdEQX8Hf-NU41yeoELF1Lu_zU/edit?usp=sharing)
...
Place the image before the level 1 heading created in task 2. Also, look at the pictures in the img/ folder and add an image in each option of guided visit.
...
- It helps developers to understand what type of data will be populated on the web page. This is important when a website or web application is developed by a team and not by a single person. For example, the design and layout of the website may be done by a web designer. A computer programmer can later quickly identify which parts of the webpage contain key content and implement functionality such as a search bar that searches for the content presented in those parts.
