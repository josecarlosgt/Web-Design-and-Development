...
> [Download the images](https://github.com/josecarlosgt/Web-Design-and-Development/raw/refs/heads/tutorial-2-designing-and-structuring-content-basic-HTML/img.zip)
...
## Task 8: Persisting the data of your web form (Advanced)

[**Persist** the data captured in the web form](https://docs.google.com/document/d/1RAIx-JZjfczV0gJI_8PNTx6jgpuOi0jKEOdl4tw8HOo/edit?usp=sharing) using Google's Apps Script Forms to store the comments from Laguna Brava Ecotourism's visitors.

Follow the tutorial ["Submit a HTML form to Google Sheets"](https://github.com/levinunnink/html-form-to-google-sheet/tree/master). 

You can re-use the code in this tutorial by viewing the code in the index.html file of this repository. The HTML document contains the following sections of code to persist the form's data to a worksheet in Google Sheets using a JavaScript program created in Apps Script Forms.

**FORM SUBMISSION MESSAGES STYLE:** Contains Cascading Style Sheets (CSS) code that adjusts the visibility of the form submission messages (below)

**FORM SUBMISSION MESSAGES:** Contains HTML code with basic messages generated during the submission of the form

**FORM SUBMISSION HANDLERS:** Contains JavaScript code that submits the data in the form to the Apps Script Forms program when the user acts on the form's 'submit' button

After completing the tutorial above, update the form's action attribute with the URL generated by Apps Script Forms.
